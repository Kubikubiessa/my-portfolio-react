 const projects = [
    ...
    },
    {
      name: "twYtter",
      description:
        "Given the uncertainty regarding the the future of the popular social media platform Twitter, this app provides a clone, with which users can send posts, make comments on posts, and follow other users.",
...

    {
      ...
      description:
        "A weather app that shows current weather conditions at a chosen location and a five-day weather forecast.",
    ...
    },
    {
      name: "Note Taker",
      description:
        "This app allows the user to enter notes that can be saved using localStorage. Notes can also be deleted.",
